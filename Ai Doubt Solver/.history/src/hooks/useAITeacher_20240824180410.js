...
export const useAITeacher = create((set, get) => ({
  ...
  askAI: async (question) => {
    ...
    switch (question.toLowerCase()) {
      case "tell me about the sign language":
        ...
        break;
      case "tell me about special ed":
        response = "Special education provides tailored educational support to students with diverse learning needs. It aims to address individual learning differences and provide equitable opportunities for all students.";
        break;
      case "tell me about maths":
        response = "Mathematics is the study of numbers, shapes, and patterns. It is fundamental to many fields including science, engineering, and technology. Mastery of math can enhance problem-solving and analytical skills.";
        break;
      default:
